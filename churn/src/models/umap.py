...
class UmapTransformer:
    ...
    def transform(self,
        ...
        """
        transfrom daataframe according to umap
        :param model: trained umap model which transforms dataframe
        :param df: dataframe to transform
        return: umap transformed dataframe
        """
